...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 12, 2025 lúc 02:50 AM
...
INSERT INTO `sach` (`MaSach`, `MaLoai`, `TenSach`, `TacGia`, `NhaXuatBan`, `NamXuatBan`, `GiaNhap`, `GiaBan`, `GiaUuDai`, `SoLuong`, `NgayCapNhat`, `DinhDang`, `SoTrang`, `NgonNgu`, `MoTa`, `TrangThai`) VALUES
(1, 1, 'Đắc Nhân Tâm', 'Dale Carnegie', 'NXB Trẻ', 2020, 50000, 75000, 70000, 100, '2024-04-10', 'Bìa mềm', 320, 'Tiếng Việt', 'Cuốn sách giúp bạn làm chủ nghệ thuật giao tiếp và ứng xử.', 1),
(2, 2, 'Tuổi Trẻ Đáng Giá Bao Nhiêu', 'Rosie Nguyễn', 'NXB Hội Nhà Văn', 2018, 40000, 65000, 60000, 80, '2024-04-15', 'Bìa mềm', 250, 'Tiếng Việt', 'Sách truyền cảm hứng cho người trẻ trên hành trình trưởng thành.', 1),
(3, 1, 'Nhà Giả Kim', 'Paulo Coelho', 'NXB Văn Học', 2019, 45000, 70000, 65000, 90, '2024-03-25', 'Bìa mềm', 300, 'Tiếng Việt', 'Hành trình khám phá bản thân và theo đuổi ước mơ.', 1),
(4, 3, 'The Subtle Art of Not Giving a F*ck', 'Mark Manson', 'HarperOne', 2016, 60000, 90000, 85000, 50, '2024-04-28', 'Bìa cứng', 280, 'Tiếng Anh', 'Một cách tiếp cận khác biệt về hạnh phúc và cuộc sống.', 1),
(5, 2, 'Đi Tìm Lẽ Sống', 'Viktor E. Frankl', 'NXB Thế Giới', 2021, 55000, 80000, 75000, 60, '2024-05-01', 'Bìa mềm', 230, 'Tiếng Việt', 'Tác phẩm kinh điển về tâm lý học và triết lý sống.', 1);
