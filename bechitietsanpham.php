...
<nav class="navbar navbar-default">
  <div class="container">
   ...
   <ul class="nav navbar-nav">
    <li class="dropdown">
     ="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Thể loại <span class="caret"></span></a>
  ...
  <div class="row">
    <div class="col-md-5">
      <div class="product-image">
        ...
        // Truy vấn cơ sở dữ liệu để lấy đường dẫn hình ảnh sản phẩm
        $sql = "SELECT DuongDanHinh FROM hinhanh WHERE MaSach = '$product_id'";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
            // Hiển thị hình ảnh sản phẩm
            while($row = $result->fetch_assoc()) {
                echo '<img src="' . $row["DuongDanHinh"] . '" class="img-responsive" alt="Sách">';
            }
        } else {
